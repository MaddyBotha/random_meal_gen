...
<div class="grid">
 <div class="feature-card">
  <img src="${meal.strMealThumb}" alt="Meal Image">
 	...
 	${meal.strCategory ? `<p class="big"><strong>Category:</strong> ${meal.strCategory}</p>` : ''}
		${meal.strArea ? `<p class="big"><strong>Area:</strong> ${meal.strArea}</p>` : ''}
		${meal.strTags ? `<p class="big"><strong>Tags:</strong> ${meal.strTags.split(',').join(', ')}</p>` : ''}
